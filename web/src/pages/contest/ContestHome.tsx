...
export const ContestHome: React.FC = () => {
  ...
  return (
    <div p-2 flex items-start>
      <div className={c('bg-white rounded-lg shadow-md pb-8 my-1', 'mx-2 w-2/3')}>
      ...
      <div className={c('bg-white rounded-lg shadow-md pb-8 my-1', 'mx-2 w-1/3')}>
        <div pt-8 px-4>
